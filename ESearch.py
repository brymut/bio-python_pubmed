...
def storeIDs(id_list, webenv = '',querykey = ''):
	Entrez.email = '2131791M@student.gla.ac.uk'
	if webenv == '':
...
if __name__ == '__main__':
    ...
    #spell_check_info = spellCheck('cancr and feveer')
    #print papers
    ...
    #for index in range(10):
    	#print (json.dumps(papers[index]['MedlineCitation']['Article']['Language']))
    	#print(json.dumps(papers[0]['MedlineCitation']['Article']['ArticleTitle'], indent=2, separators=(',', ':')))
